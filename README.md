...
**Engineering Quality:**
- 🧪 704 tests (510 Python + 194 jsdom browser cases) running in CI on Python 3.10/3.11/3.12, plus ruff, `pip-audit`, a vendor-integrity check, and a job that installs the built wheel and *serves* it
